...
module.exports = {
  ...
  userPrincipalName: process.env.NEXT_PUBLIC_USER_PRINCIPLE_NAME || 'encik.zultan@techpro3947.onmicrosoft.comm',
  ...
  protectedRoutes: ['/Movies','/Playlist'],
